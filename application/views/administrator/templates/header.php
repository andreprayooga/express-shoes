...
<head>
  ...
  <link href="<?= base_url('assets/administrator/vendor/fontawesome-free/css/all.min.css') ?>" rel="stylesheet" type="text/css">
  ...
  <!-- Date Time Picker -->
  <link rel="stylesheet" href="<?php echo base_url('assets/administrator/datetimepicker/css/bootstrap-datetimepicker.min.css');  ?>">
